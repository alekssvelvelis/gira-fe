...
export const SIDEBAR_SECTIONS: SidebarSectionInterface[] = [
    {
        title: 'Main',
        items: [
            { label: 'Dashboard', icon: <LuLayoutDashboard className='h-6 w-6 m-2 transition-all duration-300 hover:scale-110 hover:cursor-pointer'/>},
            { label: 'Calendar', icon: <LuCalendarDays className='h-6 w-6 m-2 transition-all duration-300 hover:scale-110 hover:cursor-pointer' />},
        ],
    },
    {
        title: 'Organisation',
